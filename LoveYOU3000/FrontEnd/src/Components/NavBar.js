            ...
            <div className="flex gap-2 text-white text-lg font-mono">
                ...
                {user && (
                    <div className="">
                        ...
                        {/* Add Order link conditionally based on user's email */}
                        {user.email === "shivansh@gmail.com" && (
                            <Link to='/order' className="hover:bg-red-500 hover:font-bold transition ease-in-out duration-300 active:bg-red-700 px-4 py-2 rounded-xl">
                                Order
                            </Link>
                        )}
                        {/* {user.isAdmin && ( */}
