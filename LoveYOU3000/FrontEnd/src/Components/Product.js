...
const ProductCard = () => {
  ...
  // Apply price filtering and tag matching
  ...
  // Apply slicing (show only top N products)
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="sm:flex-1 sm:flex sm:justify-center">
          <input
            ...
            className="w-full sm:w-2/3 lg:w-1/2 px-5 py-2 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-lg bg-white"
          />
        </div>
        ...
        <div className="sm:w-1/4 flex justify-center sm:justify-end">
          <select
            ...
            className="w-full sm:w-48 px-3 py-2 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-lg bg-white"
          >
        ...
        <div className="sm:w-1/4 flex justify-center sm:justify-end">
          <select
            ...
            className="w-full sm:w-48 px-4 py-2 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-lg bg-white"
          >
        ...
        <div className="sm:w-1/4 flex justify-center sm:justify-end">
          <input
            ...
            min='1'  // Added the min attribute to set the lower limit to 1
            className="w-full sm:w-48 px-4 py-2 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-lg bg-white"
          />
        </div>
      </div>
