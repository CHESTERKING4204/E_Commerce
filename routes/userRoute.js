...
route.post('/user', async (req, res) => {
    ...
    try {
        ...
        //FOR EASE REMOVING THE VALID PASSWORD AND VALID EMAIL FROM THE CODE[IN USER.JS]------*********************//
            ...
            res.status(201).json({email,token});// placing the token in the in place of the addUser it is sending a string instead of the data that previously was sent by the user 
